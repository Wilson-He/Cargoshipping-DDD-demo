package io.github.cargoshipping.application.util;

import io.github.cargoshipping.domain.model.cargo.*;
import io.github.cargoshipping.domain.model.handling.*;
...
import io.github.cargoshipping.domain.model.location.SampleLocations;
import io.github.cargoshipping.domain.model.voyage.SampleVoyages;
    ...
    public static void loadHibernateData(TransactionTemplate tt, final SessionFactory sf, final HandlingEventFactory handlingEventFactory, final HandlingEventRepository handlingEventRepository) {
        ...
        tt.execute(new TransactionCallbackWithoutResult() {
            ...
            protected void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                RouteSpecification routeSpecification = new RouteSpecification(SampleLocations.HONGKONG, SampleLocations.HELSINKI, DateTestUtil.toDate("2009-03-15"));
                TrackingId trackingId = new TrackingId("ABC123");
                Cargo abc123 = new Cargo(trackingId, routeSpecification);

                Itinerary itinerary = new Itinerary(asList(
                        new Leg(SampleVoyages.HONGKONG_TO_NEW_YORK, SampleLocations.HONGKONG, SampleLocations.NEWYORK, DateTestUtil.toDate("2009-03-02"), DateTestUtil.toDate("2009-03-05")),
                        new Leg(SampleVoyages.NEW_YORK_TO_DALLAS, SampleLocations.NEWYORK, SampleLocations.DALLAS, DateTestUtil.toDate("2009-03-06"), DateTestUtil.toDate("2009-03-08")),
                        new Leg(SampleVoyages.DALLAS_TO_HELSINKI, SampleLocations.DALLAS, SampleLocations.HELSINKI, DateTestUtil.toDate("2009-03-09"), DateTestUtil.toDate("2009-03-12"))
                ));
                ...
                try {
                    HandlingEvent event1 = handlingEventFactory.createHandlingEvent(
                            new Date(), DateTestUtil.toDate("2009-03-01"), trackingId, null, SampleLocations.HONGKONG.unLocode(), HandlingEvent.Type.RECEIVE
                    );
                    session.save(event1);

                    HandlingEvent event2 = handlingEventFactory.createHandlingEvent(
                            new Date(), DateTestUtil.toDate("2009-03-02"), trackingId, SampleVoyages.HONGKONG_TO_NEW_YORK.voyageNumber(), SampleLocations.HONGKONG.unLocode(), HandlingEvent.Type.LOAD
                    );
                    session.save(event2);

                    HandlingEvent event3 = handlingEventFactory.createHandlingEvent(
                            new Date(), DateTestUtil.toDate("2009-03-05"), trackingId, SampleVoyages.HONGKONG_TO_NEW_YORK.voyageNumber(), SampleLocations.NEWYORK.unLocode(), HandlingEvent.Type.UNLOAD
                    );
                    session.save(event3);
                ...
                RouteSpecification routeSpecification1 = new RouteSpecification(SampleLocations.HANGZOU, SampleLocations.STOCKHOLM, DateTestUtil.toDate("2009-03-18"));
                ...
                Itinerary itinerary1 = new Itinerary(asList(
                        new Leg(SampleVoyages.HONGKONG_TO_NEW_YORK, SampleLocations.HANGZOU, SampleLocations.NEWYORK, DateTestUtil.toDate("2009-03-03"), DateTestUtil.toDate("2009-03-05")),
                        new Leg(SampleVoyages.NEW_YORK_TO_DALLAS, SampleLocations.NEWYORK, SampleLocations.DALLAS, DateTestUtil.toDate("2009-03-06"), DateTestUtil.toDate("2009-03-08")),
                        new Leg(SampleVoyages.DALLAS_TO_HELSINKI, SampleLocations.DALLAS, SampleLocations.STOCKHOLM, DateTestUtil.toDate("2009-03-09"), DateTestUtil.toDate("2009-03-11"))
                ));
                ...
                try {
                    HandlingEvent event1 = handlingEventFactory.createHandlingEvent(
                            new Date(), DateTestUtil.toDate("2009-03-01"), trackingId1, null, SampleLocations.HANGZOU.unLocode(), HandlingEvent.Type.RECEIVE
                    );
                    session.save(event1);

                    HandlingEvent event2 = handlingEventFactory.createHandlingEvent(
                            new Date(), DateTestUtil.toDate("2009-03-03"), trackingId1, SampleVoyages.HONGKONG_TO_NEW_YORK.voyageNumber(), SampleLocations.HANGZOU.unLocode(), HandlingEvent.Type.LOAD
                    );
                    session.save(event2);

                    HandlingEvent event3 = handlingEventFactory.createHandlingEvent(
                            new Date(), DateTestUtil.toDate("2009-03-05"), trackingId1, SampleVoyages.HONGKONG_TO_NEW_YORK.voyageNumber(), SampleLocations.NEWYORK.unLocode(), HandlingEvent.Type.UNLOAD
                    );
                    session.save(event3);

                    HandlingEvent event4 = handlingEventFactory.createHandlingEvent(
                            new Date(), DateTestUtil.toDate("2009-03-06"), trackingId1, SampleVoyages.HONGKONG_TO_NEW_YORK.voyageNumber(), SampleLocations.NEWYORK.unLocode(), HandlingEvent.Type.LOAD
                    );
                    session.save(event4);
